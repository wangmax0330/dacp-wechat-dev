...
public class PaginationQueryContext {
	...
	public PaginationQueryContext(HttpServletRequest request) {
		...
		this.pageIndex = (StringUtils.isNotBlank(pageIndexStr) ? new Integer(pageIndexStr).intValue() : 1);
		String pageSizeStr = request.getParameter("pageSize");
		this.pageSize = (StringUtils.isNotBlank(pageSizeStr) ? new Integer(pageSizeStr).intValue() : 20);
